...
macro(ocv_detect_android_sdk)
  if(NOT DEFINED ANDROID_SDK)
    if(DEFINED ENV{ANDROID_SDK} AND EXISTS "$ENV{ANDROID_SDK}")
      set(ANDROID_SDK "$ENV{ANDROID_SDK}" CACHE INTERNAL "Android SDK path")
      elseif(DEFINED ENV{ANDROID_HOME} AND EXISTS "$ENV{ANDROID_HOME}")
      set(ANDROID_SDK "$ENV{ANDROID_HOME}" CACHE INTERNAL "Android SDK path")
    elseif(DEFINED ENV{ANDROID_SDK_ROOT} AND EXISTS "$ENV{ANDROID_SDK_ROOT}")
      set(ANDROID_SDK "$ENV{ANDROID_SDK_ROOT}" CACHE INTERNAL "Android SDK path")
    endif()
